...
import { raiseGrievanceTool } from "../Tools/RaisegrievanceTool.js";
...
const chatAgentTemplate = fs
  .readFileSync(__dirname + "/chatAgentPrompt.txt", "utf-8")
  .toString();
...
const tools = [knowledgeBaseTool, raiseGrievanceTool];
